...
class DistrictSeeder extends Seeder
{
  ...
  [
    ...
    "province_id"=> 38,
    "created_at"=> "2025-11-15T14=>48=>00.000+07=>00",
    "updated_at"=> "2025-11-15T14=>48=>00.000+07=>00",
    "deleted_at"=> null
  ],
  [
    "id"=> 5101,
  ...
  [
    ...
    foreach($items as $item){
            $chk = District::where('id',$item["id"])->first();
            if(empty($chk)){
                District::create([
                    'id' => $item["id"],
                    'name' => $item["name_th"],
                ...
                echo "District ".$item['name_th']." create successfull."."\n";
            }else{
                $chk->update([
                    'name' => $item["name_th"],
                    'province_id' => $item["province_id"],
                ]);
                echo "District ".$item['name_th']." updated successfull."."\n";
            }
        }
